...
TELEGRAM_BOT_TOKEN = '8062703701:AAH6mLyUB7NASJWta0xB-1YxYJtZb3wmEqU'
ADMIN_USER_ID = 6114033856 ,  7663163950 
...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
       "*🚀ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴛʜᴇ FLASH DDOS🚀*\n\n"
        ...
        "*💀ꜱᴇʀᴠᴇʀ ꜰʀᴇᴇᴢ ᴡɪᴛʜ @FLAME1969 , @NOMORE231 🚀*" 
    )
...
async def attack(update: Update, context: CallbackContext):
    ...
    text=(
        ...
        f"*🔥ᴜɴʟᴇᴀꜱʜɪɴɢ ꜰᴏʀᴄᴇ. ɴᴏ ᴛᴜʀɴɪɴɢ ʙᴀᴄᴋ. Powered by @FLAME1969 , @NOMORE231 💥*"
    ), parse_mode='Markdown')
